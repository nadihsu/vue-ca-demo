...
declare global {
  ...
  const useUserStore: typeof import('./src/core/user/stores/user.store')['useUserStore']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly useUserStore: UnwrapRef<typeof import('./src/core/user/stores/user.store')['useUserStore']>
